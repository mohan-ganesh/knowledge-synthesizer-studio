...
export class GeminiLiveAPI {
  constructor(proxyUrl, projectId, model, roomId = "default") {
  ...
  setupWebSocketToService() {
    ...
    this.webSocket.onerror = (event) => {
      ...
      // Error often precedes close, but we'll let close handle the retry
  ...
  scheduleReconnect() {
    if (this.retryCount >= this.maxRetries) {
      ...
      this.onErrorMessage("Maximum reconnection attempts reached. Please reconnect manually.");
      return;
    }
